...
class UrdfConverter(AssetConverterBase):
    ...
    def __init__(self, cfg: UrdfConverterCfg):
        ...
        if get_isaac_sim_version() >= Version("5.1"):
            ...
            if not manager.is_extension_enabled("isaacsim.asset.importer.urdf-2.4.30"):
                manager.set_extension_enabled_immediate("isaacsim.asset.importer.urdf-2.4.30", True)
