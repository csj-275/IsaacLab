...
from isaaclab_tasks.manager_based.piper_grab.V1.grab_ik_abs_visuomotor_env_cfg import PiperGrabVisuomotorEnvCfg
...
class PiperGrabIKAbsV1VisuomotorMimicEnvCfg(PiperGrabVisuomotorEnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "isaac_lab_piper_grab_V1_abs_visuomotor_D0"
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="object_1", subtask_term_signal="grasp_1",
                subtask_term_offset_range=(0, 0),
                selection_strategy="nearest_neighbor_object", selection_strategy_kwargs={"nn_k": 3},
                action_noise=0.01, num_interpolation_steps=0, num_fixed_steps=0,
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="box", subtask_term_signal="placed_1",
                subtask_term_offset_range=(0, 0),
                selection_strategy="nearest_neighbor_object", selection_strategy_kwargs={"nn_k": 3},
                action_noise=0.01, num_interpolation_steps=0, num_fixed_steps=0,
                apply_noise_during_interpolation=False,
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="mug", subtask_term_signal="grasp_2",
                subtask_term_offset_range=(0, 0),
                selection_strategy="nearest_neighbor_object", selection_strategy_kwargs={"nn_k": 3},
                action_noise=0.01, num_interpolation_steps=0, num_fixed_steps=0,
                apply_noise_during_interpolation=False,
        ...
        subtask_configs.append(
            SubTaskConfig(
                object_ref="box", subtask_term_signal=None,
                subtask_term_offset_range=(0, 0),
                selection_strategy="nearest_neighbor_object", selection_strategy_kwargs={"nn_k": 3},
                action_noise=0.01, num_interpolation_steps=0, num_fixed_steps=0,
                apply_noise_during_interpolation=False,
