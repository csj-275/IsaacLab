...
from isaaclab_tasks.manager_based.piper_grab.V1.grab_ik_rel_env_cfg import PiperGrabEnvCfg


@configclass
class PiperGrabIKRelV1MimicEnvCfg(PiperGrabEnvCfg, MimicEnvCfg):
    """Mimic environment config for Piper Grab IK Rel V1 two-stage task."""
    ...
    def __post_init__(self):
        ...
        # Subtask 3: Place mug into box (terminal, no signal needed)
        subtask_configs.append(
            SubTaskConfig(
                object_ref="box",
