...
from isaaclab_tasks.manager_based.piper_grab.grab_ik_rel_skillgen_env_cfg import PiperGrabSkillgenEnvCfg
...
class PiperGrabIKRelSkillgenEnvCfg(PiperGrabSkillgenEnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "demo_src_piper_grab_isaac_lab_task_D0"
