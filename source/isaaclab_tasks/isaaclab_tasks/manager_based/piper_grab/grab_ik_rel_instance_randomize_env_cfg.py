...
from . import grab_joint_pos_instance_randomize_env_cfg
...
@configclass
class PiperGrabInstanceRandomizeEnvCfg(
    grab_joint_pos_instance_randomize_env_cfg.PiperGrabInstanceRandomizeEnvCfg
):
