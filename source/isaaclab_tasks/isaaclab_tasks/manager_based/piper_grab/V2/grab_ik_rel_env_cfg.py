...
class SubtaskCfg(ObsGroup):
    """Observations for subtask group shared across V2 variants."""
...
class ObservationsCfg:
    """Observation specifications for V2 two-stage task (IK-rel, state-only)."""
...
class TerminationsCfg:
    """Termination conditions for V2 task."""
    ...
    success = DoneTerm(
        func=V2_mdp.objects_a_and_b_are_into_c,
        params={
            "robot_cfg": SceneEntityCfg("robot"),
            "object_a_cfg": SceneEntityCfg("object_1"),
...
class PiperGrabEnvCfg(grab_joint_pos_env_cfg.PiperGrabEnvCfg):
    """Configuration for V2 two-stage pick-and-place IK-rel environment."""
    ...
    def __post_init__(self):
        ...
        # # Color randomization (disabled: our local box/bottle USDs don't have materials)
