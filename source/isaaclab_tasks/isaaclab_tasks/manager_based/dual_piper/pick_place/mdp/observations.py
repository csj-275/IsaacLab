...
# ---------------------------------------------------------------------------
# V1-style 7D joint observations (joint1-6 + 1D gripper)
# ---------------------------------------------------------------------------
...
def joint_pos_target_7d(
    ...
    These are the ACTUAL commanded joint positions, computed by the IK
    controller from the IK delta pose action.
    """
    robot: Articulation = env.scene[robot_cfg.name]
