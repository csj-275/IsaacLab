...
Usage:
    ...
    python hdf5_to_mp4.py --input ./datasets/piper_visuo_dataset.hdf5 --output_dir ./datasets/videos

    # Specific demos and cameras
    python hdf5_to_mp4.py --input ./datasets/piper_visuo_dataset.hdf5 --demos demo_0,demo_1 --cameras table_cam
"""
