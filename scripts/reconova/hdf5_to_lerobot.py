...
Usage:
    ...
    python hdf5_to_lerobot.py --input ./datasets/piper_dataset.hdf5 --output ./lerobot_data

    # With images (--enable_cameras was used during recording)
    python hdf5_to_lerobot.py --input ./datasets/piper_visuo_dataset.hdf5 --output ./lerobot_data
